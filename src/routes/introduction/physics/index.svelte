<script>
  ...
  import { PhysicsMemberCardInfo as MemberCardInfo } from '$lib/components/introduction/constants/MemberCardInfo.svelte';
  import { PhysicsHashTagInfo as HashTagInfo } from '$lib/components/introduction/constants/TeamHashTagInfo.svelte';
  ...
  <Row>
    ...
    <Col xs="12" sm="9" md="10">
      <TeamIntro
        title="교육의 미래를 이끌어갈"
        subject="물리팀"
        introduction="베라디 물리팀은 팀원이 일에서 의미와 즐거움을 느낄 때 최고의 성과를 낼 수 있다고 믿습니다. 
...
<Form class="py-5" style="background-color:#edfbfd">
  <TeamHireLink
    title="교육의 혁신을 함께할 물리팀원을 찾습니다."
    introduction="물리팀이 추구하는 가치와 문화에 공감하신다면 지원하세요"
    button="물리팀 채용공고"
    url="/hire/subject/physics"
  />
</Form>