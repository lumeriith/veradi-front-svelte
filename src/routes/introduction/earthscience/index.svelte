<script>
  ...
  import { EarthscienceMemberCardInfo as MemberCardInfo} from '$lib/components/introduction/constants/MemberCardInfo.svelte';
  import { EarthscienceHashTagInfo as HashTagInfo } from '$lib/components/introduction/constants/TeamHashTagInfo.svelte';
...
<Container>
  <Row>
    <Col class="d-none d-sm-block py-4" sm="3" md="2" style="margin-left:-30px; margin-right:10px;">
      <TeamButton/>
    </Col>
    <Col xs="12" sm="9" md="10">
      <TeamIntro
        title="교육의 미래를 이끌어갈"
        subject="지구과학팀"
        introduction="베라디 지구과학팀은 팀원이 일에서 의미와 즐거움을 느낄 때 최고의 성과를 낼 수 있다고 믿습니다. 
        그 때가 바로 자신의 에너지를 기꺼이 발휘하는 희열과 몰입의 순간이니까요. 
...
<Form class="py-4" style="background-color:#edfbfd">
  <Container>
    <TeamFamilyIntro
      introduction="Introduce our family"
      subject="지구과학팀"
    />
    <Row class="py-2">
...
<Form class="py-5" style="background-color:#edfbfd">
  <TeamHireLink
    title="교육의 혁신을 함께할 지구과학 팀원을 찾습니다."
    introduction="지구과학팀이 추구하는 가치와 문화에 공감하신다면 지원하세요"
    button="지구과학팀 채용공고"
    url="/hire/subject/earthscience"
  />
</Form>